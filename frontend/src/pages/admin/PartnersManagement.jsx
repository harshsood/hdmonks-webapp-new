                        ...
                        return (
                          <div className="flex items-center gap-2 text-sm text-gray-600 mt-2">
                            ...
                            <Popover>
                              ...
                              <PopoverContent className="w-[500px] p-6 max-h-[600px] overflow-y-auto">
                                <div className="space-y-4">
                                  ...
                                  {hasServices ? (
                                    <div className="grid gap-4">
                                      {client.services.map((service, idx) => {
                                        ...
                                        return (
                                          <div key={service.id || idx} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                            <div className="flex items-center justify-between mb-3">
                                              <div>
                                                <h4 className="font-semibold text-gray-900">{service.service_name || 'Service'}</h4>
                                                <p className="text-sm text-gray-600">{formatCurrency(servicePrice)}</p>
                                              </div>
                                              <button
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                              <div className="bg-blue-50 rounded-md p-3 text-center">
                                                <div className="text-xs font-medium text-blue-700 mb-1">Referral</div>
                                                <div className="text-sm font-bold text-blue-800">{formatCurrency(referralShare)}</div>
                                                <div className="text-xs text-blue-600">{breakdown.referral_percent}%</div>
                                              </div>
                                              
                                              <div className="bg-green-50 rounded-md p-3 text-center">
                                                <div className="text-xs font-medium text-green-700 mb-1">Execution</div>
                                                <div className="text-sm font-bold text-green-800">{formatCurrency(executionShare)}</div>
                                                <div className="text-xs text-green-600">{breakdown.execution_percent}%</div>
                                              </div>
                                              
                                              <div className="bg-orange-50 rounded-md p-3 text-center">
                                                <div className="text-xs font-medium text-orange-700 mb-1">Admin</div>
                                                <div className="text-sm font-bold text-orange-800">{formatCurrency(adminShare)}</div>
                                                <div className="text-xs text-orange-600">{breakdown.admin_percent}%</div>
                                              </div>
                                            </div>
                                          </div>
                                        );
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                      <div className="grid grid-cols-3 gap-3">
                                        <div className="bg-blue-50 rounded-md p-3 text-center">
                                          <div className="text-xs font-medium text-blue-700 mb-1">Referral</div>
                                          <div className="text-sm font-bold text-blue-800">{formatCurrency(clientClosedCost * 0.1)}</div>
                                          <div className="text-xs text-blue-600">10%</div>
                                        </div>
                                        
                                        <div className="bg-green-50 rounded-md p-3 text-center">
                                          <div className="text-xs font-medium text-green-700 mb-1">Execution</div>
                                          <div className="text-sm font-bold text-green-800">{formatCurrency(clientClosedCost * 0.8)}</div>
                                          <div className="text-xs text-green-600">80%</div>
                                        </div>
                                        
                                        <div className="bg-orange-50 rounded-md p-3 text-center">
                                          <div className="text-xs font-medium text-orange-700 mb-1">Admin</div>
                                          <div className="text-sm font-bold text-orange-800">{formatCurrency(clientClosedCost * 0.1)}</div>
