...
const initialForm = { employee_code: '', first_name: '', last_name: '', date_of_birth: '', gender: '', personal_email: '', work_email: '', phone: '', date_of_joining: '', employment_type: 'full_time', department: '', designation: '', manager_user_id: '', branch: '', location: '', probation_period_days: '', confirmation_date: '', notice_period_days: '', user_id: '', bank_name: '', bank_account_number: '', bank_ifsc: '', payment_method: 'bank_transfer', tax_information: {} };
